function getTime(n) {
	return time = "", time += (Math.floor(n/3600) < 10) ? "0" + Math.floor(n/3600) + ":" : Math.floor(n/3600) + ":", time += (Math.floor((n%3600)/60) < 10) ? "0" + Math.floor((n%3600)/60) + ":" : Math.floor((n%3600)/60) + ":", time += (Math.floor(n%60) < 10) ? "0" + Math.floor(n%60) : Math.floor(n%60);
}
